...
public class KeelungSightsCrawler {
    ...
    private final Map<String, ArrayList<Sight>> myMap = new HashMap<>();
    ...
    public ArrayList<Sight> getItems(String zone) {
        ...
        if (zone.equals("全部")) {
            ...
            ArrayList<Sight> items = new ArrayList<>();

            for (ArrayList<Sight> sights : myMap.values()) {
                items.addAll(sights);
            }
